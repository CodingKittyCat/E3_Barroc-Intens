...
namespace E3_BarrocIntens.Migrations
{
    ...
    [Migration("20241111101934_AddedLeaseContracts")]
    partial class AddedLeaseContracts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E3_BarrocIntens.Data.Classes.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 1, 11, 19, 33, 459, DateTimeKind.Local).AddTicks(6941),
                            InvoiceDate = new DateTime(2024, 10, 12, 11, 19, 33, 459, DateTimeKind.Local).AddTicks(6883),
                            IsPayed = true,
                            TotalAmount = 1200.5f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 26, 11, 19, 33, 459, DateTimeKind.Local).AddTicks(6964),
                            InvoiceDate = new DateTime(2024, 10, 27, 11, 19, 33, 459, DateTimeKind.Local).AddTicks(6962),
                            IsPayed = false,
                            TotalAmount = 800.75f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 6, 11, 19, 33, 459, DateTimeKind.Local).AddTicks(6972),
                            InvoiceDate = new DateTime(2024, 9, 27, 11, 19, 33, 459, DateTimeKind.Local).AddTicks(6970),
                            IsPayed = true,
                            TotalAmount = 2500f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 21, 11, 19, 33, 459, DateTimeKind.Local).AddTicks(6977),
                            InvoiceDate = new DateTime(2024, 10, 22, 11, 19, 33, 459, DateTimeKind.Local).AddTicks(6976),
                            IsPayed = false,
                            TotalAmount = 1500.3f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 12, 1, 11, 19, 33, 459, DateTimeKind.Local).AddTicks(6980),
                            InvoiceDate = new DateTime(2024, 11, 1, 11, 19, 33, 459, DateTimeKind.Local).AddTicks(6979),
                            IsPayed = false,
                            TotalAmount = 950.6f
                        });
                });

            modelBuilder.Entity("E3_BarrocIntens.Data.Classes.Lease_Contracts", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Bkr_Check = false,
                            Company_Id = 1,
                            Date_Created = new DateTime(2024, 11, 11, 11, 19, 33, 913, DateTimeKind.Local).AddTicks(6753),
                            End_Date = new DateTime(2024, 11, 11, 11, 19, 33, 913, DateTimeKind.Local).AddTicks(6753),
                        ...
                        new
                        {
                            ...
                            Bkr_Check = false,
                            Company_Id = 2,
                            Date_Created = new DateTime(2024, 11, 11, 11, 19, 33, 913, DateTimeKind.Local).AddTicks(6865),
                            End_Date = new DateTime(2024, 11, 11, 11, 19, 33, 913, DateTimeKind.Local).AddTicks(6865),
                            Payment_Status = "Unpaid",
                        ...
                        new
                        {
                            ...
                            Bkr_Check = false,
                            Company_Id = 3,
                            Date_Created = new DateTime(2024, 11, 11, 11, 19, 33, 913, DateTimeKind.Local).AddTicks(6869),
                            End_Date = new DateTime(2024, 11, 11, 11, 19, 33, 913, DateTimeKind.Local).AddTicks(6869),
                            Payment_Status = "Unpaid",
                        ...
                        new
                        {
                            ...
                            Bkr_Check = false,
                            Company_Id = 4,
                            Date_Created = new DateTime(2024, 11, 11, 11, 19, 33, 913, DateTimeKind.Local).AddTicks(6871),
                            End_Date = new DateTime(2024, 11, 11, 11, 19, 33, 913, DateTimeKind.Local).AddTicks(6871),
                            Payment_Status = "Unpaid",
            ...
            modelBuilder.Entity("E3_BarrocIntens.Data.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Name = "Customer User",
                            Password = "$2a$11$xN64qKrFqW1hPYWjEhUjBOSjVuZdzCMa/sFH3ZgBK7TKFU8QnQdnG",
                            RoleId = 4,
                            Username = "customer"
                        },
                        new
                        {
                            Id = 2,
                            Name = "Finance User",
                            Password = "$2a$11$wy0LioGZgqI/8aIEkyoNaeYMHYv.cmORrArhhl2JuUe25Yiz1XBMe",
                            RoleId = 2,
                            Username = "finance"
                        },
                        new
                        {
                            Id = 3,
                            Name = "Sales User",
                            Password = "$2a$11$geUlUTIdU5og0qAVw.irR.hJEJGRsjTPEnoCE.c8FRhlAr6b3pT/6",
                            RoleId = 3,
                            Username = "sales"
                        },
                        new
                        {
                            ...
                            Password = "$2a$11$vUmU/aIJC57q66x6wjBkt.oWIK5DDPud4BvVyTNO6.8ny/m/PUhBa",
                            RoleId = 1,
