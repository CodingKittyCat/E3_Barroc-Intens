    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "John Doe", new DateTime(2024, 11, 22, 9, 4, 30, 894, DateTimeKind.Local).AddTicks(7197), new DateTime(2024, 11, 2, 9, 4, 30, 894, DateTimeKind.Local).AddTicks(7122), true, 1200.5f },
                    { 2, "Jane Smith", new DateTime(2024, 12, 17, 9, 4, 30, 894, DateTimeKind.Local).AddTicks(7206), new DateTime(2024, 11, 17, 9, 4, 30, 894, DateTimeKind.Local).AddTicks(7205), false, 800.75f },
                    { 3, "Acme Corp", new DateTime(2024, 11, 27, 9, 4, 30, 894, DateTimeKind.Local).AddTicks(7232), new DateTime(2024, 10, 18, 9, 4, 30, 894, DateTimeKind.Local).AddTicks(7209), true, 2500f },
                    { 4, "Global Industries", new DateTime(2024, 12, 12, 9, 4, 30, 894, DateTimeKind.Local).AddTicks(7236), new DateTime(2024, 11, 12, 9, 4, 30, 894, DateTimeKind.Local).AddTicks(7235), false, 1500.3f },
                    { 5, "Tech Solutions", new DateTime(2024, 12, 22, 9, 4, 30, 894, DateTimeKind.Local).AddTicks(7244), new DateTime(2024, 11, 22, 9, 4, 30, 894, DateTimeKind.Local).AddTicks(7238), false, 950.6f }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "D295372@edu.curio.nl", true, "Customer User1", "$2a$11$D7LUDxY5Pl5zhHyOKpeo/.6ucVZFcFf6sHpf5xj8cCxBgvxLTFS1K", 4, "customer1" },
                    { 2, "customer2@example.com", true, "Customer User2", "$2a$11$fKcf5JqD0JjK32Cpr3SKu./kaM8H3b30d6JmUESRNlyeVkkkMEiAK", 4, "customer2" },
                    { 3, "customer3@example.com", true, "Customer User3", "$2a$11$oMH6zYcylHf9M5lePVGEl.p50hLvwEOVybVrlptjcKeE0PWFmcLLO", 4, "customer3" },
                    { 4, "finance@example.com", true, "Finance User", "$2a$11$2vEVbNsqUrbZVHDVqKkPIOUFyQy/s7.cimqlyTwpkgjMYo5xED9n2", 2, "finance" },
                    { 5, "sales@example.com", true, "Sales User", "$2a$11$Rqm6PBtpuvviNsC4epVIEu1m/GXkCl7YZVot8B0TSPqnWeMYeXcLW", 3, "sales" },
                    { 6, "maintenance@example.com", true, "Maintenance User", "$2a$11$NGNXLBarxfxvowcWyKR9KuWixXfZ5UuU9NH13A81tvkuAI6XFzv7G", 1, "maintenance" },
                    { 7, "georgecassel@example.com", true, "George Cassel", "$2a$11$npBtRIJG77AMXNUlkMKG.uCXuzKZKDVNjHcWvdP./AjwVhXyHQX7u", 1, "georgecassel" },
                    { 8, "stanbaker@example.com", true, "Stan Baker", "$2a$11$JUidKx.mUEQVwdUNXokhW.tGktcrcQYSj4ozPMdcDgUg7tGUdbnge", 1, "stanbaker" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, false, new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(3995), new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(3995), "Unpaid", 100.0, 1, 1, 1000.0, "Monthly", 1 },
                    { 2, 1, false, new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4092), new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4092), "Unpaid", 200.0, 1, 1, 2000.0, "Monthly", 2 },
                    { 3, 1, false, new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4098), new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4098), "Unpaid", 300.0, 1, 1, 3000.0, "Monthly", 3 },
                    { 4, 1, false, new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4103), new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4103), "Unpaid", 400.0, 1, 1, 4000.0, "Monthly", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 1, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4177), new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4173), "Pending", 1000m },
                    { 2, 2, new DateTime(2025, 1, 1, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4212), new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4210), "Pending", 2000m },
                    { 3, 3, new DateTime(2025, 1, 1, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4230), new DateTime(2024, 12, 2, 9, 4, 32, 131, DateTimeKind.Local).AddTicks(4223), "Pending", 3000m }
                });
