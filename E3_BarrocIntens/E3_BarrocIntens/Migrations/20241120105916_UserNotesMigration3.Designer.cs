...
namespace E3_BarrocIntens.Migrations
{
    ...
    [Migration("20241120105916_UserNotesMigration3")]
    partial class UserNotesMigration3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E3_BarrocIntens.Data.Classes.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 10, 11, 59, 15, 371, DateTimeKind.Local).AddTicks(8614),
                            InvoiceDate = new DateTime(2024, 10, 21, 11, 59, 15, 371, DateTimeKind.Local).AddTicks(8567),
                            IsPayed = true,
                            TotalAmount = 1200.5f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 12, 5, 11, 59, 15, 371, DateTimeKind.Local).AddTicks(8626),
                            InvoiceDate = new DateTime(2024, 11, 5, 11, 59, 15, 371, DateTimeKind.Local).AddTicks(8623),
                            IsPayed = false,
                            TotalAmount = 800.75f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 15, 11, 59, 15, 371, DateTimeKind.Local).AddTicks(8630),
                            InvoiceDate = new DateTime(2024, 10, 6, 11, 59, 15, 371, DateTimeKind.Local).AddTicks(8628),
                            IsPayed = true,
                            TotalAmount = 2500f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 30, 11, 59, 15, 371, DateTimeKind.Local).AddTicks(8640),
                            InvoiceDate = new DateTime(2024, 10, 31, 11, 59, 15, 371, DateTimeKind.Local).AddTicks(8638),
                            IsPayed = false,
                            TotalAmount = 1500.3f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 12, 10, 11, 59, 15, 371, DateTimeKind.Local).AddTicks(8650),
                            InvoiceDate = new DateTime(2024, 11, 10, 11, 59, 15, 371, DateTimeKind.Local).AddTicks(8648),
                            IsPayed = false,
                            TotalAmount = 950.6f
                        });
                });
            ...
            modelBuilder.Entity("E3_BarrocIntens.Data.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Name = "Customer User",
                            Password = "$2a$11$AH4lpwH.gmh.oNGANmA1m.3Uo.KhLWuLDWReX7vtmMX4e2ismyLGW",
                            RoleId = 4,
                            Username = "customer"
                        },
                        new
                        {
                            Id = 2,
                            Name = "Finance User",
                            Password = "$2a$11$jqBdT1v.ZhUJIE6Ou4FX9ehzHVarW2a7bZ65BtIbP4AguC8slLB.m",
                            RoleId = 2,
                            Username = "finance"
                        },
                        new
                        {
                            Id = 3,
                            Name = "Sales User",
                            Password = "$2a$11$WY3ICuk2jiFtOrspgAayqe.cvgfZbjhZuGcmnL67I5OVVMEVB72ly",
                            RoleId = 3,
                            Username = "sales"
                        },
                        new
                        {
                            ...
                            Password = "$2a$11$f9mL/OQCCskPRA5ZM0ckGudCzW52Dj6tGjdvR.gDejA8tof8U63sy",
                            RoleId = 1,
                        ...
                        new
                        {
                            Id = 5,
                            Name = "Customer2",
                            Password = "$2a$11$h1HhxA.C5Wf.aWMbqHCCZeUSeohZK1Yzx8RRWXjwCd4/kkp3Zowuq",
                            RoleId = 4,
                            Username = "customer2"
                        });
                });
