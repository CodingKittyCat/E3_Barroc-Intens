    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "John Doe", new DateTime(2024, 11, 22, 9, 58, 38, 175, DateTimeKind.Local).AddTicks(6), new DateTime(2024, 11, 2, 9, 58, 38, 174, DateTimeKind.Local).AddTicks(9948), true, 1200.5f },
                    { 2, "Jane Smith", new DateTime(2024, 12, 17, 9, 58, 38, 175, DateTimeKind.Local).AddTicks(19), new DateTime(2024, 11, 17, 9, 58, 38, 175, DateTimeKind.Local).AddTicks(18), false, 800.75f },
                    { 3, "Acme Corp", new DateTime(2024, 11, 27, 9, 58, 38, 175, DateTimeKind.Local).AddTicks(41), new DateTime(2024, 10, 18, 9, 58, 38, 175, DateTimeKind.Local).AddTicks(21), true, 2500f },
                    { 4, "Global Industries", new DateTime(2024, 12, 12, 9, 58, 38, 175, DateTimeKind.Local).AddTicks(44), new DateTime(2024, 11, 12, 9, 58, 38, 175, DateTimeKind.Local).AddTicks(43), false, 1500.3f },
                    { 5, "Tech Solutions", new DateTime(2024, 12, 22, 9, 58, 38, 175, DateTimeKind.Local).AddTicks(48), new DateTime(2024, 11, 22, 9, 58, 38, 175, DateTimeKind.Local).AddTicks(45), false, 950.6f }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "D295372@edu.curio.nl", true, "Customer User1", "$2a$11$Omx0CBHwLzAOlmJ1i/jZ.OSsARma53s5Kg8u0bB1lnp4D0bGzP/T2", 4, "customer1" },
                    { 2, "customer2@example.com", true, "Customer User2", "$2a$11$HyyjzZy7JfSczBfAvvZhM.2Z4XA6IUF3eSVBbZXJUBx8yi97lCfbC", 4, "customer2" },
                    { 3, "customer3@example.com", true, "Customer User3", "$2a$11$oLLupnLTqX37PpMuNUNjrON2N5yEMi1fzeRRvqOCQBdhpsXqmFHHO", 4, "customer3" },
                    { 4, "finance@example.com", true, "Finance User", "$2a$11$u/yL3XnqCvA0st2XDc0FTeYlFnlWf6PC8GmFbqMJBytWoyMnrAU1O", 2, "finance" },
                    { 5, "sales@example.com", true, "Sales User", "$2a$11$tPo8HtDb36vh/A8S9m4DfOSVm6AUTCv3P/s7tjWcSjxPaPlKnfgqS", 3, "sales" },
                    { 6, "maintenance@example.com", true, "Maintenance User", "$2a$11$U5wZi4HlrGXRbAQMaEti0ODy5z4ImJBEFIqomxTaALUOiqJyu4EHC", 1, "maintenance" },
                    { 7, "georgecassel@example.com", true, "George Cassel", "$2a$11$y6pZALn5g1V7t1j5NBf0SuCEYu8rPmKRhYEoxUvthKR6wB8Pyc6GC", 1, "georgecassel" },
                    { 8, "stanbaker@example.com", true, "Stan Baker", "$2a$11$.4OfgKwqvjbpmAZzDcum2O93FoOZ8aypFvc.uawCV7iRC8uIlxAlm", 1, "stanbaker" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, false, new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6145), new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6145), "Unpaid", 100.0, 1, 1, 1000.0, "Monthly", 1 },
                    { 2, 1, false, new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6252), new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6252), "Unpaid", 200.0, 1, 1, 2000.0, "Monthly", 2 },
                    { 3, 1, false, new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6259), new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6259), "Unpaid", 300.0, 1, 1, 3000.0, "Monthly", 3 },
                    { 4, 1, false, new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6262), new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6262), "Unpaid", 400.0, 1, 1, 4000.0, "Monthly", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 1, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6336), new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6334), "Pending", 1000m },
                    { 2, 2, new DateTime(2025, 1, 1, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6372), new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6370), "Pending", 2000m },
                    { 3, 3, new DateTime(2025, 1, 1, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6387), new DateTime(2024, 12, 2, 9, 58, 39, 90, DateTimeKind.Local).AddTicks(6380), "Pending", 3000m }
                });
