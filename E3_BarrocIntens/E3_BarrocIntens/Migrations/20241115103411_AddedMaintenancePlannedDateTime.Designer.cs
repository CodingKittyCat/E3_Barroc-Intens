...
namespace E3_BarrocIntens.Migrations
{
    ...
    [Migration("20241115103411_AddedMaintenancePlannedDateTime")]
    partial class AddedMaintenancePlannedDateTime
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("E3_BarrocIntens.Data.Classes.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 5, 11, 34, 8, 716, DateTimeKind.Local).AddTicks(9645),
                            InvoiceDate = new DateTime(2024, 10, 16, 11, 34, 8, 716, DateTimeKind.Local).AddTicks(9573),
                            IsPayed = true,
                            TotalAmount = 1200.5f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 30, 11, 34, 8, 716, DateTimeKind.Local).AddTicks(9655),
                            InvoiceDate = new DateTime(2024, 10, 31, 11, 34, 8, 716, DateTimeKind.Local).AddTicks(9653),
                            IsPayed = false,
                            TotalAmount = 800.75f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 10, 11, 34, 8, 716, DateTimeKind.Local).AddTicks(9659),
                            InvoiceDate = new DateTime(2024, 10, 1, 11, 34, 8, 716, DateTimeKind.Local).AddTicks(9658),
                            IsPayed = true,
                            TotalAmount = 2500f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 25, 11, 34, 8, 716, DateTimeKind.Local).AddTicks(9674),
                            InvoiceDate = new DateTime(2024, 10, 26, 11, 34, 8, 716, DateTimeKind.Local).AddTicks(9672),
                            IsPayed = false,
                            TotalAmount = 1500.3f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 12, 5, 11, 34, 8, 716, DateTimeKind.Local).AddTicks(9685),
                            InvoiceDate = new DateTime(2024, 11, 5, 11, 34, 8, 716, DateTimeKind.Local).AddTicks(9683),
                            IsPayed = false,
                            TotalAmount = 950.6f
                        });
                });
            ...
            modelBuilder.Entity("E3_BarrocIntens.Data.Classes.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Name = "Customer User",
                            Password = "$2a$11$EaEuepb09uldnyNAAYui8uqaeTIpPPBAj90JkfTgBj/OGGMdQLjnO",
                            RoleId = 4,
                            Username = "customer"
                        },
                        new
                        {
                            Id = 2,
                            Name = "Finance User",
                            Password = "$2a$11$qJexDf1MwEkaHzeKa7ZslO1NaBTdnWeGSUT/gDGR0ygXfqP5RGGta",
                            RoleId = 2,
                            Username = "finance"
                        },
                        new
                        {
                            Id = 3,
                            Name = "Sales User",
                            Password = "$2a$11$yD3O5ntqtwprIgTeq4/RJ.tbUX1I4N.xRkPKdUJ5Drupam2z1CIrm",
                            RoleId = 3,
                            Username = "sales"
                        },
                        new
                        {
                            ...
                            Password = "$2a$11$SGh6ktSFruO5A887OtfhROI6sPTiVzQ5UKc0SEQu1hzHSZUfhU.QK",
                            RoleId = 1,
