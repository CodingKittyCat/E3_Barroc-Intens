...
namespace E3_BarrocIntens.Migrations
{
    ...
    [Migration("20241202085734_InitialMigration")]
            ...
            modelBuilder.Entity("E3_BarrocIntens.Data.Classes.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 22, 9, 57, 33, 19, DateTimeKind.Local).AddTicks(4062),
                            InvoiceDate = new DateTime(2024, 11, 2, 9, 57, 33, 19, DateTimeKind.Local).AddTicks(3972),
                            IsPayed = true,
                            TotalAmount = 1200.5f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 12, 17, 9, 57, 33, 19, DateTimeKind.Local).AddTicks(4071),
                            InvoiceDate = new DateTime(2024, 11, 17, 9, 57, 33, 19, DateTimeKind.Local).AddTicks(4069),
                            IsPayed = false,
                            TotalAmount = 800.75f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 11, 27, 9, 57, 33, 19, DateTimeKind.Local).AddTicks(4105),
                            InvoiceDate = new DateTime(2024, 10, 18, 9, 57, 33, 19, DateTimeKind.Local).AddTicks(4073),
                            IsPayed = true,
                            TotalAmount = 2500f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 12, 12, 9, 57, 33, 19, DateTimeKind.Local).AddTicks(4111),
                            InvoiceDate = new DateTime(2024, 11, 12, 9, 57, 33, 19, DateTimeKind.Local).AddTicks(4109),
                            IsPayed = false,
                            TotalAmount = 1500.3f
                        },
                        new
                        {
                            ...
                            DueDate = new DateTime(2024, 12, 22, 9, 57, 33, 19, DateTimeKind.Local).AddTicks(4119),
                            InvoiceDate = new DateTime(2024, 11, 22, 9, 57, 33, 19, DateTimeKind.Local).AddTicks(4114),
                            IsPayed = false,
                            TotalAmount = 950.6f
                        });
                });
            ...
            modelBuilder.Entity("E3_BarrocIntens.Data.Classes.LeaseContract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount_Of_Periods = 1,
                            Bkr_Check = false,
                            Date_Created = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(1941),
                            End_Date = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(1941),
                        ...
                        new
                        {
                            ...
                            Amount_Of_Periods = 1,
                            Bkr_Check = false,
                            Date_Created = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2034),
                            End_Date = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2034),
                            Payment_Status = "Unpaid",
                        ...
                        new
                        {
                            ...
                            Amount_Of_Periods = 1,
                            Bkr_Check = false,
                            Date_Created = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2165),
                            End_Date = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2165),
                            Payment_Status = "Unpaid",
                        ...
                        new
                        {
                            ...
                            Amount_Of_Periods = 1,
                            Bkr_Check = false,
                            Date_Created = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2174),
                            End_Date = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2174),
                            Payment_Status = "Unpaid",
            ...
            modelBuilder.Entity("E3_BarrocIntens.Data.Classes.Quote", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CustomerId = 1,
                            ExpirationDate = new DateTime(2025, 1, 1, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2277),
                            QuoteDate = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2272),
                            Status = "Pending",
                            TotalAmount = 1000m
                        },
                        new
                        {
                            Id = 2,
                            CustomerId = 2,
                            ExpirationDate = new DateTime(2025, 1, 1, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2625),
                            QuoteDate = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2614),
                            Status = "Pending",
                            TotalAmount = 2000m
                        },
                        new
                        {
                            Id = 3,
                            CustomerId = 3,
                            ExpirationDate = new DateTime(2025, 1, 1, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2653),
                            QuoteDate = new DateTime(2024, 12, 2, 9, 57, 34, 50, DateTimeKind.Local).AddTicks(2642),
                            Status = "Pending",
                            TotalAmount = 3000m
                        });
                });
            ...
            modelBuilder.Entity("E3_BarrocIntens.Data.Classes.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsFirstLogin = true,
                            Name = "Customer User1",
                            Password = "$2a$11$sMTbExgH5YD40vwviXPeLOiFXj2VFVylJm1OiGZDKvJKVpW9cMBKu",
                            RoleId = 4,
                            Username = "customer1"
                        },
                        new
                        {
                            ...
                            IsFirstLogin = true,
                            Name = "Customer User2",
                            Password = "$2a$11$H0hjOb6n8aUi45ozHqGPvuJiATyEReNWs8m0oneL0O6O5.IxZGZV2",
                            RoleId = 4,
                            Username = "customer2"
                        },
                        new
                        {
                            ...
                            IsFirstLogin = true,
                            Name = "Customer User3",
                            Password = "$2a$11$8x0od4zuD4zR4p0k4E5DrOOfEHd5yGjevclNcYpKApk78hv1ARKce",
                            RoleId = 4,
                            Username = "customer3"
                        },
                        new
                        {
                            ...
                            IsFirstLogin = true,
                            Name = "Finance User",
                            Password = "$2a$11$lsNTjfn8nVXG6KHH7.t8out0m/omAOVG13wItzqXOS7lTl5BPJO72",
                            RoleId = 2,
                            Username = "finance"
                        },
                        new
                        {
                            ...
                            IsFirstLogin = true,
                            Name = "Sales User",
                            Password = "$2a$11$iDzgHtQWtwIH5crgUH6Ke.QxwmTXwMRb2BHZ1w6azkX3emHERx8aS",
                            RoleId = 3,
                            Username = "sales"
                        },
                        new
                        {
                            ...
                            Password = "$2a$11$aqXYI6NUf4NlCJMis7zj0.YsMZK3JbKO98BhCp4dQZzN/DoYZbpAe",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            IsFirstLogin = true,
                            Name = "George Cassel",
                            Password = "$2a$11$.kDVy/qoTIDFXkt9sXsllONq0zuxdrhiXhbsDAYqn/FPF/gqgUhpO",
                            RoleId = 1,
                        ...
                        new
                        {
                            ...
                            IsFirstLogin = true,
                            Name = "Stan Baker",
                            Password = "$2a$11$wHqigdc/2rHereo1YFi/bOGdwrR7g7UwkEbLu4B0plSZ17l7WM3JS",
                            RoleId = 1,
                            Username = "stanbaker"
                        });
                });
