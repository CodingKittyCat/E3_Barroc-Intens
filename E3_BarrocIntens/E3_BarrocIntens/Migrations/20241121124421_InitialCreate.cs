    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "John Doe", new DateTime(2024, 11, 11, 13, 44, 20, 624, DateTimeKind.Local).AddTicks(5093), new DateTime(2024, 10, 22, 13, 44, 20, 624, DateTimeKind.Local).AddTicks(5004), true, 1200.5f },
                    { 2, "Jane Smith", new DateTime(2024, 12, 6, 13, 44, 20, 624, DateTimeKind.Local).AddTicks(5140), new DateTime(2024, 11, 6, 13, 44, 20, 624, DateTimeKind.Local).AddTicks(5138), false, 800.75f },
                    { 3, "Acme Corp", new DateTime(2024, 11, 16, 13, 44, 20, 624, DateTimeKind.Local).AddTicks(5148), new DateTime(2024, 10, 7, 13, 44, 20, 624, DateTimeKind.Local).AddTicks(5146), true, 2500f },
                    { 4, "Global Industries", new DateTime(2024, 12, 1, 13, 44, 20, 624, DateTimeKind.Local).AddTicks(5153), new DateTime(2024, 11, 1, 13, 44, 20, 624, DateTimeKind.Local).AddTicks(5152), false, 1500.3f },
                    { 5, "Tech Solutions", new DateTime(2024, 12, 11, 13, 44, 20, 624, DateTimeKind.Local).AddTicks(5157), new DateTime(2024, 11, 11, 13, 44, 20, 624, DateTimeKind.Local).AddTicks(5155), false, 950.6f }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Customer User", "$2a$11$OsI0Prr2eMC7sqKtEGLjxO/iCx2Z389SSAYO4BChS6Hs47zAyMFkK", 4, "customer" },
                    { 2, "Finance User", "$2a$11$LFiWFjAPawvs/1XmY1A/JOqaqgtY6q41FQYsYJgdVzHCUB91vRtVq", 2, "finance" },
                    { 3, "Sales User", "$2a$11$NjQgiVCOKIxTGagz6mSMSOCYE9bQEEMqEpQqWubNFDKm73MZOaNHy", 3, "sales" },
                    { 4, "Maintenance User", "$2a$11$oplfp1lscvXT3v6odg./SuYBPin7SJ9EjPlbsDSt7RAVF28A9TjJy", 1, "maintenance" },
                    { 5, "George Cassel", "$2a$11$BTg7U2A8m7VZQupIhFA9B.Q9PIsVZvcQl6nTP9DiNo6SHGXgpAbyC", 1, "georgecassel" },
                    { 6, "Stan Baker", "$2a$11$2WRt8H97WiyN3WtOrZtj7eg/0oXQDIp.gq0bTe2X8/zmw/MpLRyMe", 1, "stanbaker" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, false, new DateTime(2024, 11, 21, 13, 44, 21, 323, DateTimeKind.Local).AddTicks(25), new DateTime(2024, 11, 21, 13, 44, 21, 323, DateTimeKind.Local).AddTicks(25), "Unpaid", 100.0, 1, 1, 1000.0, "Monthly", 1 },
                    { 2, 1, false, new DateTime(2024, 11, 21, 13, 44, 21, 323, DateTimeKind.Local).AddTicks(182), new DateTime(2024, 11, 21, 13, 44, 21, 323, DateTimeKind.Local).AddTicks(182), "Unpaid", 200.0, 1, 1, 2000.0, "Monthly", 2 },
                    { 3, 1, false, new DateTime(2024, 11, 21, 13, 44, 21, 323, DateTimeKind.Local).AddTicks(187), new DateTime(2024, 11, 21, 13, 44, 21, 323, DateTimeKind.Local).AddTicks(187), "Unpaid", 300.0, 1, 1, 3000.0, "Monthly", 3 },
                    { 4, 1, false, new DateTime(2024, 11, 21, 13, 44, 21, 323, DateTimeKind.Local).AddTicks(190), new DateTime(2024, 11, 21, 13, 44, 21, 323, DateTimeKind.Local).AddTicks(190), "Unpaid", 400.0, 1, 1, 4000.0, "Monthly", 4 }
                });
